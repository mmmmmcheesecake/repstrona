(function () {
    ...
    const DICT = {
        en: {
            ...
            'vs.subtitle': 'Upload a photo and find similar products on Taobao and 1688.',
            'vs.drop': 'Drop an image here or click to upload',
            'vs.search': 'Search',
            'vs.reset': 'Reset',
            'vs.searching': 'Searching…',
            'vs.empty': 'No matches found for this photo.',
        ...
        pl: {
            ...
            'vs.subtitle': 'Wgraj zdjęcie żeby znaleźć podobne produkty na Taobao i 1688.',
            'vs.drop': 'Upuść zdjęcie tutaj lub kliknij żeby wgrać',
            'vs.search': 'Szukaj',
            'vs.reset': 'Wyczyść',
            'vs.searching': 'Szukam…',
            'vs.empty': 'Brak podobnych produktów dla tego zdjęcia.',
